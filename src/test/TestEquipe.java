...
//			System.out.println(diStefano.getNom() + " appartient � l'�quipe " + diStefano.getEquipe().getClub());
//		else
//			System.out.println(diStefano.getNom() + " n'appartient � aucune �quipe!");
//
//		if (judas.getEquipe() != null)
//			System.out.println(judas.getNom() + " appartient � l'�quipe " +judas.getEquipe().getClub());
//		else
//			System.out.println(judas.getNom() + " n'appartient � aucune �quipe!");
//	}
//}
